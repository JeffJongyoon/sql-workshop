...
db_user <- 'admin'
db_password <- 'son11207'
db_name <- 'joenewnee'
db_host <- 'database-1.cikcbzxocq20.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
dbWriteTable(mydb, "Toydata", Toy)
dbListTables(mydb)
dbReadTable(mydb,'Toydata')
dbGetQuery(mydb, "SELECT x AS 'Random Normal' FROM Toydata LIMIT 20;")
```
...
dbGetQuery(mydb, "UPDATE Toydata SET x='NULL' WHERE z='1';")
dbGetQuery(mydb, "SELECT * FROM Toydata")
```
...
dbGetQuery(mydb, "INSERT INTO toy VALUES (1,2,1);")
dbGetQuery(mydb, "INSERT INTO toy VALUES (-1,.1,1);")
dbGetQuery(mydb, "INSERT INTO toy VALUES (0.4,-2,0);")
dbGetQuery(mydb, "INSERT INTO toy VALUES (0.4,-2,0);")
dbReadTable(mydb, 'toy')


dbGetQuery(mydb,"INSERT INTO toy (x,y,z) SELECT score, id_student, date_submitted FROM studentAssessment;")
dbGetQuery(mydb, "DROP TABLE toy;")
dbGetQuery(mydb, "SELECT * FROM toy;") #This should produce an error
```
